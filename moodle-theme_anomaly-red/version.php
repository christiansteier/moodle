...
$plugin->component = 'theme_anomalyred'; // Full name of the plugin (used for diagnostics).

$plugin->maturity  = MATURITY_STABLE;

$plugin->release   = 'Anomaly Red 3.1 (Build: 20160813)'; // Human-friendly version name.
